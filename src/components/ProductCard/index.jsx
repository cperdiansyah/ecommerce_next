...
const ProductCard = ({ product }) => {
  return (
    <div className='flex items-center justify-center flex-wrap flex-col py-4 px-3 bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-xl text-slate-700 lg:max-w-[18%] max-w-[35%] mt-5 lg:mt-0   '>
